...
The easiest approach is to use File Transfer Protocol (FTP). When you signed up for web hosting, your host will have provided you with FTP login details. To use FTP you need a program like [Filezilla](https://filezilla-project.org) (free for all platforms).
